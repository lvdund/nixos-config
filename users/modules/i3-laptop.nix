{
  ...
  home.file = {
    ".config/i3".source = config.lib.file.mkOutOfStoreSymlink "/etc/nixos/nixos-config/config/i3-laptop";
    ".config/polybar".source = config.lib.file.mkOutOfStoreSymlink "/etc/nixos/nixos-config/config/polybar-laptop";
